      ...
      <div className="mx-auto max-w-3xl h-screen lg:h-screen px-6 lg:px-8">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="text-lg mt-3 text-gray-600 dark:text-gray-300">
            Get in touch using this form. Alternatively, you can always reach me
            on my socials or shoot me an email at{" "}
            <span>
              <a
                className="underline"
                href="mailto:msalopek@pm.me?title=Hi, Matija!"
              >
                msalopek@pm.me
              </a>
            </span>
        ...
        <form
          ...
          className="mt-12 border dark:border-gray-500 shadow-lg bg-base-300 duration-300"
        >
            <div className={`${state.succeeded ? "flex justify-center items-center h-1/2 bg-base-100" : "hidden"}`}>
              <AnimatedSuccesCheckmark />
            </div>
            <div className={`${state.succeeded ? "hidden" : "grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8 p-8"}`}>
                ...
                <div className="flex items-start">
                  <div className="ml-3">
                    <p className="text-base text-gray-500 dark:text-gray-300">
                      ...
                      By submitting this form, you agree to share your concact
                      information with me and me only.
                    </p>
                  </div>
                </div>
              </div>
